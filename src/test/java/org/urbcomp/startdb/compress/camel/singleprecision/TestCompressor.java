package org.urbcomp.startdb.compress.camel.singleprecision;
...
import org.urbcomp.startdb.compress.camel.compressor32.*;
import org.urbcomp.startdb.compress.camel.decompressor32.*;
...
public class TestCompressor {
    ...
    private void testELFCompressor32(String fileName, Map<String, List<ResultStructure>> resultCompressor) throws FileNotFoundException {
        org.urbcomp.startdb.compress.camel.singleprecision.FileReader fileReader = new org.urbcomp.startdb.compress.camel.singleprecision.FileReader(FILE_PATH + fileName);
